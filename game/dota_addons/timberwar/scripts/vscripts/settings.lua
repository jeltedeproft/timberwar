...
TREE_REGROW_TIME = 2.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?
...
CAMERA_DISTANCE_OVERRIDE = 1834          -- How far out should we allow the camera to go?  Use -1 for the default (1134) while still allowing for panorama camera distance changes
